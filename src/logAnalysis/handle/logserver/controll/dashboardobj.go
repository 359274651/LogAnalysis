...
func (rs *ReqCountStatusArea) ToQueryData() *QueryData {
	...
	qd.Contidions = []KeyContidion{KeyContidion{"match": []Contidion{Contidion{"time_local", "大于等于", sd}, Contidion{"time_local", "小于等于", ed}}, "group": []Contidion{Contidion{"_id", "", "$status"}, Contidion{"sum_status", "", bson.M{"$sum": 1}}}}}
